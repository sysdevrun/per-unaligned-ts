...
export default function App() {
  const [activeTab, setActiveTab] = useState<'codec' | 'explorer'>('codec');
        ...
        {activeTab === 'codec' ? (
          ...
          <section>
            ...
            <p className="text-sm text-gray-600 mb-4">
              Parse an ASN.1 module and interactively fill in values with constraint validation,
              then encode to PER hex.
            </p>
            <div className="bg-white rounded-lg border border-gray-200 p-6">
              <SchemaExplorer />
            </div>
